 ...
 * 
 * 
 * Modified by Robinton: added put- and get- ShortArray, getIsType,
 *  and removeTag methods.
 * Once again, Don't do evil.
 */
...
public class CompoundTag extends Tag {
    ...
    {
    	tags.put(name, new ShortArrayTag(name, value));
    }
    ...
    public short[] getShortArray(String name)
    {
        ...
        {
            return ((ShortArrayTag)tags.get(name)).data;
        }
    }
	...
	public boolean getIsType(String name, Class<? extends Tag> cl)
	{
        if(!tags.containsKey(name))
        {
            return false;
        ...
        {
        	return cl.isInstance(tags.get(name));
        }
	}
